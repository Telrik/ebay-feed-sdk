...
class ScheduleApi
{
        ...
        try {
            ...
            switch ($statusCode) {
                case 201:
                    ...
                    return [ObjectSerializer::deserialize($content, 'object', []), $response->getStatusCode(), $response->getHeaders()];
            }
            $returnType = 'object';
    ...
    {
        return $this->createScheduleAsyncWithHttpInfo($create_user_schedule_request)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->deleteScheduleAsyncWithHttpInfo($schedule_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function deleteScheduleRequest($schedule_id)
    {
        ...
        // path params
        if ($schedule_id !== null) {
            $resourcePath = str_replace('{' . 'schedule_id' . '}', ObjectSerializer::toPathValue($schedule_id), $resourcePath);
        }
        if ($multipart) {
    ...
    {
        return $this->getLatestResultFileAsyncWithHttpInfo($schedule_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getLatestResultFileRequest($schedule_id)
    {
        ...
        if ($multipart) {
            $headers = $this->headerSelector->selectHeadersForMultipart(['application/octet-stream']);
        } else {
            $headers = $this->headerSelector->selectHeaders(['application/octet-stream'], []);
        }
        // for model (json/xml)
        if (count($formParams) > 0) {
            if ($multipart) {
    ...
    public function getScheduleWithHttpInfo($schedule_id)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\\OpenAPI\\Client\\Model\\UserScheduleResponse' === '\\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\\OpenAPI\\Client\\Model\\UserScheduleResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\UserScheduleResponse', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\UserScheduleResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getScheduleAsyncWithHttpInfo($schedule_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getScheduleTemplateWithHttpInfo($schedule_template_id)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\\OpenAPI\\Client\\Model\\ScheduleTemplateResponse' === '\\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\\OpenAPI\\Client\\Model\\ScheduleTemplateResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\ScheduleTemplateResponse', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\ScheduleTemplateResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getScheduleTemplateAsyncWithHttpInfo($schedule_template_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getScheduleTemplateRequest($schedule_template_id)
    {
        ...
        if ($schedule_template_id !== null) {
            $resourcePath = str_replace('{' . 'schedule_template_id' . '}', ObjectSerializer::toPathValue($schedule_template_id), $resourcePath);
        }
        if ($multipart) {
            $headers = $this->headerSelector->selectHeadersForMultipart(['application/json']);
        } else {
    ...
    public function getScheduleTemplatesWithHttpInfo($feed_type, $limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\\OpenAPI\\Client\\Model\\ScheduleTemplateCollection' === '\\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\\OpenAPI\\Client\\Model\\ScheduleTemplateCollection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\ScheduleTemplateCollection', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\ScheduleTemplateCollection', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getScheduleTemplatesAsyncWithHttpInfo($feed_type, $limit, $offset)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getScheduleTemplatesRequest($feed_type, $limit = null, $offset = null)
    {
        ...
        $multipart = false;
        // query params
        $queryParams = array_merge($queryParams, !empty(ObjectSerializer::toQueryValue(
            $feed_type,
            'feed_type',
            // param base name
            'string',
    ...
    public function getSchedulesWithHttpInfo($feed_type, $limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\\OpenAPI\\Client\\Model\\UserScheduleCollection' === '\\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\\OpenAPI\\Client\\Model\\UserScheduleCollection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\UserScheduleCollection', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\UserScheduleCollection', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getSchedulesAsyncWithHttpInfo($feed_type, $limit, $offset)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->updateScheduleAsyncWithHttpInfo($schedule_id, $update_user_schedule_request)->then(function ($response) {
            return $response[0];
        });
    }
    /**
