...
class InventoryTaskApi
{
    ...
    {
        return $this->createInventoryTaskAsyncWithHttpInfo($create_inventory_task_request, $x_ebay_c_marketplace_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\InventoryTask', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\InventoryTask', $e->getResponseHeaders());
    ...
    {
        return $this->getInventoryTaskAsyncWithHttpInfo($task_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\InventoryTaskCollection', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\InventoryTaskCollection', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getInventoryTasksAsyncWithHttpInfo($feed_type, $schedule_id, $look_back_days, $date_range, $limit, $offset)->then(function ($response) {
            return $response[0];
        });
    }
    /**
