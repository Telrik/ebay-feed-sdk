...
class TaskApi
{
    ...
    {
        return $this->createTaskAsyncWithHttpInfo($create_task_request, $x_ebay_c_marketplace_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->getInputFileAsyncWithHttpInfo($task_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->getResultFileAsyncWithHttpInfo($task_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\Task', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\Task', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getTaskAsyncWithHttpInfo($task_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getTasksWithHttpInfo($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\\OpenAPI\\Client\\Model\\TaskCollection' === '\\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\\OpenAPI\\Client\\Model\\TaskCollection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\TaskCollection', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\TaskCollection', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getTasksAsyncWithHttpInfo($date_range, $feed_type, $limit, $look_back_days, $offset, $schedule_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->uploadFileAsyncWithHttpInfo($task_id, $creation_date, $file_name, $modification_date, $name, $read_date, $size, $type)->then(function ($response) {
            return $response[0];
        });
    }
    /**
