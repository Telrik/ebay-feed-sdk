...
class OrderTaskApi
{
    ...
    {
        return $this->createOrderTaskAsyncWithHttpInfo($create_order_task_request, $x_ebay_c_marketplace_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\OrderTask', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\OrderTask', $e->getResponseHeaders());
    ...
    {
        return $this->getOrderTaskAsyncWithHttpInfo($task_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\OrderTaskCollection', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\OrderTaskCollection', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getOrderTasksAsyncWithHttpInfo($date_range, $feed_type, $limit, $look_back_days, $offset, $schedule_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
