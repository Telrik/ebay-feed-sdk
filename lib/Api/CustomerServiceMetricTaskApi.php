...
class CustomerServiceMetricTaskApi
{
    ...
    {
        return $this->createCustomerServiceMetricTaskAsyncWithHttpInfo($accept_language, $create_service_metrics_task_request)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getCustomerServiceMetricTaskWithHttpInfo($task_id)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\\OpenAPI\\Client\\Model\\ServiceMetricsTask' === '\\SplFileObject') {
                        ...
                        if ('\\OpenAPI\\Client\\Model\\ServiceMetricsTask' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\ServiceMetricsTask', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\ServiceMetricsTask', $e->getResponseHeaders());
    ...
    {
        return $this->getCustomerServiceMetricTaskAsyncWithHttpInfo($task_id)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getCustomerServiceMetricTasksWithHttpInfo($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\\OpenAPI\\Client\\Model\\CustomerServiceMetricTaskCollection' === '\\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\\OpenAPI\\Client\\Model\\CustomerServiceMetricTaskCollection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\CustomerServiceMetricTaskCollection', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\CustomerServiceMetricTaskCollection', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getCustomerServiceMetricTasksAsyncWithHttpInfo($date_range, $feed_type, $limit, $look_back_days, $offset)->then(function ($response) {
            return $response[0];
        });
    }
    /**
