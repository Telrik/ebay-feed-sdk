...
class SupportedConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['default_value' => 'string', 'property' => 'string', 'usage' => 'string'];
    /**
     ...
     */
    protected static $openAPIFormats = ['default_value' => null, 'property' => null, 'usage' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['default_value' => 'defaultValue', 'property' => 'property', 'usage' => 'usage'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['default_value' => 'setDefaultValue', 'property' => 'setProperty', 'usage' => 'setUsage'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['default_value' => 'getDefaultValue', 'property' => 'getProperty', 'usage' => 'getUsage'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
