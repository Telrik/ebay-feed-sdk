...
class InventoryTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['task_id' => 'string', 'status' => 'string', 'feed_type' => 'string', 'creation_date' => 'string', 'completion_date' => 'string', 'schema_version' => 'string', 'detail_href' => 'string', 'upload_summary' => '\\OpenAPI\\Client\\Model\\UploadSummary', 'filter_criteria' => '\\OpenAPI\\Client\\Model\\InventoryFilterCriteria', 'inventory_file_template' => 'string'];
    /**
     ...
     */
    protected static $openAPIFormats = ['task_id' => null, 'status' => null, 'feed_type' => null, 'creation_date' => null, 'completion_date' => null, 'schema_version' => null, 'detail_href' => null, 'upload_summary' => null, 'filter_criteria' => null, 'inventory_file_template' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['task_id' => 'taskId', 'status' => 'status', 'feed_type' => 'feedType', 'creation_date' => 'creationDate', 'completion_date' => 'completionDate', 'schema_version' => 'schemaVersion', 'detail_href' => 'detailHref', 'upload_summary' => 'uploadSummary', 'filter_criteria' => 'filterCriteria', 'inventory_file_template' => 'inventoryFileTemplate'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['task_id' => 'setTaskId', 'status' => 'setStatus', 'feed_type' => 'setFeedType', 'creation_date' => 'setCreationDate', 'completion_date' => 'setCompletionDate', 'schema_version' => 'setSchemaVersion', 'detail_href' => 'setDetailHref', 'upload_summary' => 'setUploadSummary', 'filter_criteria' => 'setFilterCriteria', 'inventory_file_template' => 'setInventoryFileTemplate'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['task_id' => 'getTaskId', 'status' => 'getStatus', 'feed_type' => 'getFeedType', 'creation_date' => 'getCreationDate', 'completion_date' => 'getCompletionDate', 'schema_version' => 'getSchemaVersion', 'detail_href' => 'getDetailHref', 'upload_summary' => 'getUploadSummary', 'filter_criteria' => 'getFilterCriteria', 'inventory_file_template' => 'getInventoryFileTemplate'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
