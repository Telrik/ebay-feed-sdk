...
class ServiceMetricsTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['completion_date' => 'string', 'creation_date' => 'string', 'detail_href' => 'string', 'feed_type' => 'string', 'filter_criteria' => '\\OpenAPI\\Client\\Model\\CustomerServiceMetricsFilterCriteria', 'schema_version' => 'string', 'status' => 'string', 'task_id' => 'string'];
    /**
     ...
     */
    protected static $openAPIFormats = ['completion_date' => null, 'creation_date' => null, 'detail_href' => null, 'feed_type' => null, 'filter_criteria' => null, 'schema_version' => null, 'status' => null, 'task_id' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['completion_date' => 'completionDate', 'creation_date' => 'creationDate', 'detail_href' => 'detailHref', 'feed_type' => 'feedType', 'filter_criteria' => 'filterCriteria', 'schema_version' => 'schemaVersion', 'status' => 'status', 'task_id' => 'taskId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['completion_date' => 'setCompletionDate', 'creation_date' => 'setCreationDate', 'detail_href' => 'setDetailHref', 'feed_type' => 'setFeedType', 'filter_criteria' => 'setFilterCriteria', 'schema_version' => 'setSchemaVersion', 'status' => 'setStatus', 'task_id' => 'setTaskId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['completion_date' => 'getCompletionDate', 'creation_date' => 'getCreationDate', 'detail_href' => 'getDetailHref', 'feed_type' => 'getFeedType', 'filter_criteria' => 'getFilterCriteria', 'schema_version' => 'getSchemaVersion', 'status' => 'getStatus', 'task_id' => 'getTaskId'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
